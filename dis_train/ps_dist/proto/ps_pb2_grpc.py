...
from ps_dist.proto import ps_pb2 as ps__pb2
...
class ParameterServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Push = channel.unary_unary(
                ...
                request_serializer=ps__pb2.Req_Push_Dictionary.SerializeToString,
                response_deserializer=ps__pb2.ParameterPushResp.FromString,
                )
        self.Pull = channel.unary_unary(
                '/ParameterService/Pull',
                request_serializer=ps__pb2.ParameterPullReq.SerializeToString,
                response_deserializer=ps__pb2.Res_Pull_Dictionary.FromString,
                )
...
def add_ParameterServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Push': grpc.unary_unary_rpc_method_handler(
                    servicer.Push,
                    request_deserializer=ps__pb2.Req_Push_Dictionary.FromString,
                    response_serializer=ps__pb2.ParameterPushResp.SerializeToString,
            ),
            'Pull': grpc.unary_unary_rpc_method_handler(
                    servicer.Pull,
                    request_deserializer=ps__pb2.ParameterPullReq.FromString,
                    response_serializer=ps__pb2.Res_Pull_Dictionary.SerializeToString,
            ),
    }
...
class ParameterService(object):
    ...
    def Push(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ParameterService/Push',
            ps__pb2.Req_Push_Dictionary.SerializeToString,
            ps__pb2.ParameterPushResp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Pull(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ParameterService/Pull',
            ps__pb2.ParameterPullReq.SerializeToString,
            ps__pb2.Res_Pull_Dictionary.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
